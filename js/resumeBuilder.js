...
$("#main").append("Levi Wallach");

var awesomeThoughts = "I am Levi and I am AWESOME!";
...
var formattedSchoolDates = HTMLschoolName.replace("%data%", education["dates"]);
var formattedSchoolLocation = HTMLschoolName.replace("%data%", education["city"]);
...
$("#topContacts").append(HTMLtwitter.replace("%data%", bio.contacts.location));
...
function inName(name) {
	...
	var firstName = fullName[0].slice(0,1).toUpperCase() + fullName[0].slice(1,fullName[0].length).toLowerCase();
